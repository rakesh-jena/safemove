...
<head>        
	...
	<link rel="stylesheet" href="public/assets/assets_web/bootstrap/css/bootstrap.min.css">
	<link rel="stylesheet" href="public/assets/assets_web/font-awesome/css/font-awesome.min.css">
	<link rel="stylesheet" href="public/assets/assets_web/css/form-elements.css">
	<link rel="stylesheet" href="public/assets/assets_web/ultimate-flat-social-icons/ultm-css/ultm.css">
	<link rel="stylesheet" href="public/assets/assets_web/css/style.css">
	<link rel="stylesheet" href="public/assets/assets_web/css/media-queries.css"> 
</head>
	...
	<a id="link" target="_blank" href="{{URL::to('/dashboard')}}">{{ trans('app.login')}}</a>	
	 ...
	 <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right" style="margin-right: 70px;">
	  <li class="dropdown">
		...
		<img width="22.66" height="16" src="public/assets/flags/@if(Session::get('locale_image')){{Session::get('locale_image')}} @endif"/>
		 @else
			 <img width="22.66" height="16" src="public/assets/flags/america.png"/>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-7 footer-copyright">
				<p>© {{date('Y')}} <a href="{{URL::to('/')}}">Get It Ready</a></p>
			</div>
...
<!-- Javascript -->
<script src="public/assets/assets_web/js/jquery-1.11.1.min.js"></script>
<script src="public/assets/assets_web/bootstrap/js/bootstrap.min.js"></script>
<script src="public/assets/assets_web/js/jquery.backstretch.min.js"></script>
<script src="public/assets/assets_web/js/jquery.countdown.min.js"></script>
<script src="public/assets/assets_web/twitter/jquery.tweet.min.js"></script>
<script src="http://maps.google.com/maps/api/js?sensor=true"></script>
<script src="public/assets/assets_web/js/jquery.ui.map.min.js"></script>
<script src="public/assets/assets_web/js/scripts.js"></script>
