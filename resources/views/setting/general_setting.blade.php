			...
			<div class="form-group" >
				<label class="example-title">{{ trans('app.choose_logo')}}</label>
					<div class="fileupload fileupload-new" data-provides="fileupload" >
						...
						@if(!empty($view->logo))											
						<img class="img-circle img-bordered img-bordered-orange fileupload-new " width="170" height="170" src="{{URL::asset('public/uploads')}}/{{$view->logo}} " alt="...">
						@else
							<img class="img-circle img-bordered img-bordered-orange fileupload-new " width="170" height="170" src="{{URL::asset('public/images/default.png')}}" alt="...">					
						@endif
