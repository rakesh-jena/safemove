                        ...
                        <div class="tabbable-line">
                            <div class="tab-content">
                                <div class="row" style="transform: none;">
                                    <div class="col-md-12">
                                        <form method="POST" role="form" action="" accept-charset="UTF-8" id="expenseCategoryForm" name="expenseCategoryForm" >
                                            {{ csrf_field() }}
                                            <div class="row">
                                                <h4 style="margin-left: 20px;"><i class="fa fa-fw fa-tasks"> </i>&nbsp;Expense Category</h4>
                                                <hr style="border:1px solid lightgray">
                                                <br>
                                                <div class="form-group">
                                                    <label for="" class="control-label col-md-1">Category</label>
                                                    <div class="form-group col-md-3">
                                                        <input type="text" class="form-control" id="expense_category" name="expense_category" placeholder="Enter Expense Category" >
                                                    </div>
                                                    <label for="" class="control-label col-md-2">Description</label>
                                                    <div class="form-group col-md-3">
                                                        <input type="text" class="form-control" id="expense_desp" name="expense_desp" placeholder="Enter Description" >
                                                    </div>
