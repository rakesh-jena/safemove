...
<div class="divClass" id="printDiv" >
        ...
        <table  class="table-bordered table-responsive" width="100%" style="background-color: #f5f5f5;">
            ...
            @if($quotData->cost_type=="cost_include1")
                ...
                <tr>
                    ...
                    <td style="text-align: right"><h5><b>{{ $quotData->net_amount }}</b></h5></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2"><h6><span class="clsRed"> # Our Cost Exclude :</span> Freight on Value @3% on the declare value of Goods, GST @18%.</h6></td>
                </tr>
            @else
                <tr>
                    <td style="text-align: right"><h5>Total Amount </h5></td>
                ...
                <tr>
                    ...
                    <td style="text-align: right"><h5>{{ $quotData->after_service_tax }}</h5></td>
                </tr>
                <tr>
    ...
    <div>
        ...
        <ul>
            <li> Our Quotation is valid for a period of 45 Days.</li>
