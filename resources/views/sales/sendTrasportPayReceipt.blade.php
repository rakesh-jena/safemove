...
<div id="printDiv" align="center">
        ...
        <div align="left" style="width:740px; margin-top:0px;">
            <table width="740px">
                ...
                <tr height="20px">
                    ...
                    <td style="border:#000 solid 1px;"align="center">{{ $PayRecpData->cn_no }}</td>
                </tr>
                <tr height="20px">
                    <td>In Words</td>
                    <td>:</td>
                ...
                <tr height="20px">
                    <td>Paid by</td>
                    <td>:</td>
                    <td style="border:#000 solid 1px; width:300px;" ><input type="checkbox" {{ ($PayRecpData->payment_mode=="Cash")?"checked":"" }} > Cash <input type="checkbox" {{ ($PayRecpData->payment_mode=="Cheque")?"checked":"" }}> Cheque </td>
    ...
    <div align="left" style="margin-left:auto; margin-right:auto; margin-top:110px; width:740px;">
        <div align="justify" style="font-family:Verdana, Geneva, sans-serif; position:absolute; font-size:12px; width:500px; height:50px;margin-left:120px; margin-right:auto; margin-top:-5px;">
            <div align="center"><font size="+1" face="Verdana, Geneva, sans-serif">Safemove Movers and Packers</font></div>
            <div align="justify" style="width:450px;">
                {{ $companyDetails->add_line1 }} {{ $companyDetails->add_line2 }}<br>
...
<br><br>
<form method="POST" role="form" action="{{ url('/sendPrintTransPayRcp') }}" accept-charset="UTF-8">
    {{ csrf_field() }}
    <input type="hidden" name="consignment_no" value="{{ $PayRecpData->cn_no }}">
    <input type="hidden" name="trp_id" value="{{ $trp_id }}">
