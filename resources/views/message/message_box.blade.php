...
@foreach($receivemessage as $view)
	...
	<img class="img-responsive" src="public/{{(!empty($view->receiveMessage->image)?'uploads' :'images')}}/{{(!empty($view->receiveMessage->image)?$view->receiveMessage->image :'default.png')}}" alt="..."></a>
	</td>
